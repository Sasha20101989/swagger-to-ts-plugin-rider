...
public class AutoApiDialog extends DialogWrapper {
    ...
    public AutoApiDialog(com.intellij.openapi.actionSystem.AnActionEvent e) {
        super(true);
    ...
    protected void doOKAction() {
        ...
        String directoryPath = tsPathField.getText().trim();
        String fileName = tsFileNameField.getText().trim();
        ...
        boolean resultTs = TypeScriptGenerator.generateTypeScriptClient(url, outputFilePath, os);
        if (resultTs) {
